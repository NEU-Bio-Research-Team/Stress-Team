...
graph LR
    ...
    subgraph Time_t ["Kỳ t (Hiện tại - Cơ chế Vi mô Momentum)"]
        ...
        subgraph Market_State ["Môi trường Khách quan"]
            ...
            P_hat["Trung bình Giá (P_hat_t)<br/>[Memory]"]
            LOB_t["Sổ lệnh (Ask_t / Bid_t)"]
            Eta_L["Độ trễ Cấu trúc (η_L)<br/>[Exogenous/Physical]"]
        end
        
        subgraph Agent_Mind ["Tâm trí Momentum Trader (Chủ quan)"]
        ...
        %% Khối lượng Thực khớp NẰM TRÊN SÀN GIAO DỊCH
        Exec_t(("Khối lượng Thực khớp<br/>[Outcome - Y]"))
        
        P_t -->|"So sánh xu hướng"| Exp_t
        ...
        %% Cổng Kiểm duyệt Nhận thức (Cognitive Gate)
        Exp_t -->|"Tín hiệu Xu hướng"| I_thr
        ...
        Omega_t -.->|"Trừ hao V vị thế mở"| Demand_t
